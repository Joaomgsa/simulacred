...
@Entity
@Table(name = "parcela_price")
public class ParcelaPrice {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "id_parcela_price")
    private Long idParcelaPrice;
    ...
    public ParcelaPrice(Simulacao simulacao, Integer numeroParcela, BigDecimal valorAmortizacao,
    ...
    // Getters and Setters
    public Long getIdParcelaPrice() {
        return idParcelaPrice;
    }

    public void setIdParcelaPrice(Long idParcelaPrice) {
        this.idParcelaPrice = idParcelaPrice;
    }
